    ...
    FlipClock.DailyCounterFace = FlipClock.Face.extend({
      ...
      build: function(b) {
        ...
        (b = b ? b : this.factory.time.getDayCounter(this.showSeconds)),
          ...
          this.showSeconds
            ? a(this.createDivider("Detik")).insertBefore(
                this.lists[this.lists.length - 2].$el
              )
            : (e = 2),
          a(this.createDivider("Menit")).insertBefore(
            this.lists[this.lists.length - 4 + e].$el
          ),
          a(this.createDivider("Jam")).insertBefore(
            this.lists[this.lists.length - 6 + e].$el
          ),
          a(this.createDivider("Hari", !0)).insertBefore(this.lists[0].$el),
          this.base();
      },
      flip: function(a, b) {
...
(function($) {
  ...
  var dt1 = new Date("Sep 09, 2023 23:37:25").getTime();
