        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title">List Schedule</h4>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="col mb-4 mt-4">
                                <a href="{{ route('schedules.create')}}" class="btn btn-primary"><i class="fe fe-plus"></i> Add Schedule</a>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <form action="{{ route('schedules.destroy',$schedule->id) }}" method="POST">
                                                    ...
                                                    <a class="btn btn-sm btn-success" href="{{ route('schedules.edit',$schedule->id) }}">Edit</a>
