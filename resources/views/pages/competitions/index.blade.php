        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title">List Competition</h4>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="col mb-4 mt-4">
                                <a href="{{ route('competitions.create')}}" class="btn btn-primary"><i class="fe fe-plus"></i> Add Competition</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped text-nowrap mb-0" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $competition->match_number->name }}</td>
                                            <td>{{ $competition->type }}</td>
                                            <td>{{ $competition->gender }}</td>
                                            <td>{{ $competition->classification }}</td>
            
                                            <td class="text-right">
                                                <form action="{{ route('competitions.destroy',$competition->id) }}" method="POST">
                                    
                                                    <a class="btn btn-sm btn-success" href="{{ route('competitions.edit',$competition->id) }}">Edit</a>
