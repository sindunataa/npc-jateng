        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title">List Match Number</h4>
                </div>
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped text-nowrap mb-0" id="example1">
                                    ...
                                    <tbody>
                                        @foreach ($match_numbers as $key => $match_number)
                                        <tr>
                                            <td>{{ $key+1 }}</td>
                                            ...
                                            <td>{{ $match_number->classification->name }}</td>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add Match Number</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('match_numbers.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="">
