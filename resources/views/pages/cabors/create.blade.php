        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title">Add Cabor</h4>
                </div>
                <div class="page-rightheader ml-auto d-lg-flex d-none">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Cabor</li>
                    </ol>
                </div>
            </div>
            <!--End Page header-->
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add New Cabor</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('cabors.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="">
