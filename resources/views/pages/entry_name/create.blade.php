        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title">Add Entry By Name</h4>
                </div>
                <div class="page-rightheader ml-auto d-lg-flex d-none">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Entry By Name</li>
                    </ol>
                </div>
            </div>
            <!--End Page header-->
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add New Name</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('entry_names.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="name" class="form-label">Nama :</label>
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Masukan Nama Peserta" value="{{ old('name') }}">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror" id="nik" placeholder="Masukan NIK Peserta" value="{{ old('nik') }}">
                                    @error('nik')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control @error('status') is-invalid @enderror" placeholder="status" id="status">
                                        ...
                                        <option value="Non Kuota">Non Kuota</option>
                                    </select>
                                    @error('status')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="place_of_birth" class="form-control @error('place_of_birth') is-invalid @enderror" id="place_of_birth" placeholder="Masukan Tempat Lahir Peserta" value="{{ old('place_of_birth') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date_of_birth" class="form-control @error('date_of_birth') is-invalid @enderror" id="date_of_birth" placeholder="Masukan Tanggal Lahir Peserta" value="{{ old('date_of_birth') }}">
                                    @error('date_of_birth')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" id="address" placeholder="Masukan Alamat Peserta" value="{{ old('address') }}">
                                    @error('address')
                                ...
                                <div class="form-group" id="of-status">
                                ...
                                <div class="form-group" id="of-category">
                                    ...
                                    <select type="text" name="category" class="form-control @error('category') is-invalid @enderror" placeholder="category" id="category">
                                        <option value="Elite 1" data-nomor="1">Elite 1</option>
                                        <option value="Elite 2" data-nomor="2">Elite 2</option>
                                        <option value="Elite 3" data-nomor="3">Elite 3</option>
                                        <option value="Non Elite" data-nomor="7">Non Elite</option>
                                    </select>
                                    @error('category')
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive-md">
                                            ...
                                            <tbody id="tbody-nomor">   
                                                <tr>
                                                    <td>
                                                        <input type="text" class="form-control cabor_2"  name="cabor_id[]" placeholder="" disabled>
                                                    </td>
                                                    <td>
                                                        <select type="text"  name="classification_id[]" id="classification_0" class="form-control classification" placeholder="classification_id" onchange="select_kelas(0)" >
                                                            <option label="Pilih Salah Satu"></option>
                                                        </select>
                                                    </td>
                                                    <td class="text-center">
                                                        <select type="text" name="match_number_id[]" id="match_number_0" class="form-control match_number" placeholder="match_number_id" >
                                                            <option label="Pilih Salah Satu"></option>
                                                        </select>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="table-responsive-md">
                                        ...
                                        <thead>
                                          <tr>
                                            ...
                                            <th class="text-center of-dokumen">Dokumen MDF</th>
                                          </tr>
                                        </thead>
                                        <tbody>
                                          <tr>
                                            <td>
                                                <input type="file" class="dropify" data-height="180"  name="file_foto">
                                                @error('file_foto')
                                                    <label id="file_foto-error" class="error mt-2 text-danger" for="file_foto">{{$message}}</label>
                                                @enderror
                                            </td>
                                            <td class="text-center">
                                                <input type="file" class="dropify" data-height="180"  name="file_ktp">
                                                @error('file_ktp')
                                                    <label id="file_ktp-error" class="error mt-2 text-danger" for="file_ktp">{{$message}}</label>
                                                @enderror
                                            </td>
                                            <td class="of-dokumen">
                                                <input type="file" class="dropify" data-height="180"  name="file_pendukung">
