                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="col mb-4 mt-4">
                                <a href="{{ route('sliders.create')}}" class="btn btn-primary"><i class="fe fe-plus"></i> Add Slider</a>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <form action="{{ route('sliders.destroy',$slider->id) }}" method="POST">
                                                    ...
                                                    <a class="btn btn-sm btn-success" href="{{ route('sliders.edit',$slider->id) }}">Edit</a>
