            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('members.update',['id'=> $edit->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select type="text" name="peserta" value="{{ $edit->peserta }}" class="form-control mb-2" placeholder="Peserta">
                                    ...
                                    <div class="form-group">
                                        <label for="contingent_id" class="form-label">Contingents_id :</label>
                                        <select type="text" name="contingent_id" class="form-control" placeholder="contingent_id" id="contingent_id">
                                            ...
                                            <option value="{{$contingent->id}}" {{($contingent->id == $edit->cabor_id)?"selected":"";}}>{{$contingent->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('contingent_id')
                                    ...
                                    <div class="form-group">
                                        <label for="cabor_id" class="form-label">cabor_id :</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="place_of_birth" class="form-control" id="place_of_birth" value="{{ $edit->place_of_birth }}" placeholder="place_of_birth">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="wd-200 mg-b-30">
											<div class="input-group">
												...
												</div><input class="form-control" type="date" id="date_of_birth" name="date_of_birth" value="{{$edit->date_of_birth}}">
                                                @error('date_of_birth')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" class="form-control" id="address" placeholder="address" value="{{ $edit->address }}">
                                        @error('address')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kalurahan" class="form-control" id="kalurahan" placeholder="kalurahan" value="{{ $edit->kalurahan }}">
                                        @error('kalurahan')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kecamatan" class="form-control" id="kecamatan" placeholder="kecamatan" value="{{ $edit->kecamatan }}">
                                        @error('kecamatan')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kota" class="form-control" id="kota" placeholder="kota" value="{{ $edit->kota }}">
                                        @error('kota')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select type="text" name="status" id="status" value="{{ $edit->status }}" class="form-control" >
                                            ...
                                            <option value="no Kuota" <?= $edit->status == 'no Kuota' ? 'selected' : '' ?>>No Kuota</option>
                                        </select>
                                        @error('status')
