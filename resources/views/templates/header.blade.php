    ...
    <div class="container">
        <div class="d-flex">
            <a class="header-brand text-left" href="index.html">
                <img src="{{ asset('images/logo-peparpov-2023.png')}}" class="header-brand-img desktop-lgo" alt="Dashtic logo">
                <img src="{{ asset('images/logo-peparpov-2023.png')}}" class="header-brand-img dark-logo" alt="Dashtic logo">
                <img src="{{ asset('images/simple-peparpov-2023.png')}}" class="header-brand-img mobile-logo" alt="Dashtic logo">
                <img src="{{ asset('images/simple-peparpov-2023.png')}}" class="header-brand-img darkmobile-logo" alt="Dashtic logo">
            </a>
            ...
            <div class="d-flex order-lg-2 ml-auto">
                ...
                <div class="dropdown profile-dropdown">
                    <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                        <span>
                            <img src="{{ Auth::user()->role == 'admin' ?  asset('images/maskot-peparprov-2023.jpg') : asset('uploads/'.Auth::user()->contingent->image)}}" alt="img" class="avatar avatar-md brround" style="border: solid 1px #505ac3;">
                        </span>
                        {{-- <span>
                            <img src="{{ asset('images/maskot-peparprov-2023.jpg')}}" alt="img" class="avatar avatar-md brround" style="border: solid 1px #505ac3;">
                        </span> --}}
                    </a>
